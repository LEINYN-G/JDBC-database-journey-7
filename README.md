...
Let's move ahead and install MySQL and learn the basic concepts of MySQL before we learn how to work with it in Java.
Installing MySQL is quite similar and easy on all of the major operating systems. In this section, we will look at the installation of MySQL on Windows.
